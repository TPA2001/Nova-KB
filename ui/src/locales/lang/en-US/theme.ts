export default {
  ...
  defaultTip: 'The default is the Nova-KB platform interface, supports custom settings',
  logoDefaultTip: 'The default is the Nova-KB login interface, supports custom settings',
